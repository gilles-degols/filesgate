...
import net.degols.filesgate.libs.filesgate.pipeline.PipelineStepMessage
import net.degols.filesgate.libs.filesgate.pipeline.datasource.{DataSource, DataSourceSeed}
import net.degols.filesgate.libs.filesgate.pipeline.download.{Download, DownloadMessage}
import net.degols.filesgate.libs.filesgate.pipeline.matcher.{Matcher, MatcherMessage}
import net.degols.filesgate.libs.filesgate.pipeline.poststorage.{PostStorage, PostStorageMessage}
import net.degols.filesgate.libs.filesgate.pipeline.predownload.{PreDownload, PreDownloadMessage}
import net.degols.filesgate.libs.filesgate.pipeline.prestorage.{PreStorage, PreStorageMessage}
import net.degols.filesgate.libs.filesgate.pipeline.storage.{Storage, StorageMessage}
